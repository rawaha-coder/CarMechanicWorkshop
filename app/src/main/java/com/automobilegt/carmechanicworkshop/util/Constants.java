...
public class Constants {
    ...
    public static final String FIRST_SERVER = "https://agt-app.automobilegt.com/workshop/";
    public static final String SECOND_SERVER = "https://agt-app.automobilegt.com/test/";
